        ...
        Some(adapter) => {
            match data_set_name.as_str() {
                ...
                "MissingCharacteristicGenericAccessAdapter" => {
                    ...
                    set_attribute_or_return_error!(generic_access_service.set_uuid(
                        "00001800-0000-1000-8000-00805f9b34fb".to_owned()), sender);
                    ...
                    set_attribute_or_return_error!(heart_rate_service.set_uuid(
                        "0000180d-0000-1000-8000-00805f9b34fb".to_owned()), sender);
                ...
                "MissingDescriptorGenericAccessAdapter" => {
                    ...
                    set_attribute_or_return_error!(adapter.set_name(String::from("MissingDescriptorGenericAccessAdapter"
                                                                    .to_owned())),
                                                   sender);
                    set_attribute_or_return_error!(adapter.set_powered(true), sender);
                    set_attribute_or_return_error!(adapter.set_discoverable(true), sender);
                    ...
                    set_attribute_or_return_error!(device_name_characteristic.set_uuid(
                        "00002a00-0000-1000-8000-00805f9b34fb".to_owned()), sender);
                    ...
                    set_attribute_or_return_error!(pheripheral_privacy_flag_characteristic.set_uuid(
                        "00002a02-0000-1000-8000-00805f9b34fb".to_owned()), sender);
                    ...
                    set_attribute_or_return_error!(heart_rate_measurement_characteristic.set_uuid(
                        "00002a37-0000-1000-8000-00805f9b34fb".to_owned()), sender);
                    ...
                    set_attribute_or_return_error!(body_sensor_location_characteristic_1.set_uuid(
                        "00002a38-0000-1000-8000-00805f9b34fb".to_owned()), sender);
                    ...
                    set_attribute_or_return_error!(body_sensor_location_characteristic_2.set_uuid(
                        "00002a38-0000-1000-8000-00805f9b34fb".to_owned()), sender);
