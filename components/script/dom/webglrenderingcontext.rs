...
impl WebGLRenderingContext {
    ...
    pub fn validate_fb_attachment_enums(&self, target: u32, attachment: u32, pname: u32) -> bool {
        match target {
...
impl WebGLRenderingContextMethods for WebGLRenderingContext {
    ...
    fn GetFramebufferAttachmentParameter(
        ...
        if !self.validate_fb_attachment_enums(target, attachment, pname) {
            self.webgl_error(InvalidEnum);
            return NullValue();
        }
